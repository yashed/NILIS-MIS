            ...
            <div class="subject-dropdown">
                <div class="input-attendance">
                    <div class="custom-dropdown-attendance">
                        ...
                        <select id="sub" name="SelectedOption">

                            <option value="repete" name="SelectedOption">
                                Update verified Repeat Students
                            </option>
                            <option value="medical" name="SelectedOption">
                                Update approved Medical Students
                            </option>
                        </select>

                    </div>
                    <button class="btn-primary" type="submit" name="selectOption" value="option">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($rmStudents as $rmstudent): ?>
                                ...
                                <tr>
                                    <td id='rm-td'><input type="text" name="indexNo[]" value="<?= $rmstudent->indexNo ?>"
                                            readonly>
...
<script>
    ...
    function closeAttendancePopup() {
        document.querySelector("#RM-popup").classList.remove("active");
