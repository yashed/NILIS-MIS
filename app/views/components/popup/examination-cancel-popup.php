    ...
    <div class="results-delete-popup" id="result-sheet-delete-popup">
        ...
        <div class="delete-card-rs">
            ...
            <div class="delete-text">
                <h2>Are you sure?</h2>
                <p>Do you realy want to exit from examination creation process?</p>
            </div>

            <form class="rs-form" method="post" id='delete-rs-form'>
                <button name='cancel-exam' value='cancel' type="submit" class="delete-bt-rs">Cancel</button>
            </form>
    ...
    <body>
        ...
        <script>
            document.querySelector("#close-delete-popup-rs").addEventListener("click", function () {
                document.querySelector("#exam-cancel").classList.remove("active");
                document.querySelector("#exam-create-body").classList.remove("active");
            });
        </script>