...
<?php if ($role == "director") : ?>
    ...
    <div class="hero">
        <nav>
        <ul class="hero-ul">
                <li class="hero-ul-li"><a href="<?= ROOT ?>director/notification"><i class="bx bxs-bell icon"><?php if(isset($notification_count_obj_director)): ?>
...
<?php if ($role == "Clerk") : ?>
    ...
    <div class="hero">
        <nav>
            <ul class="hero-ul">
                <li class="hero-ul-li"><a href="<?= ROOT ?>clerk/notification"> <i class="bx bxs-bell icon"> <?php if(isset($notification_count_obj)): ?>
                    <span class="notification-badge"><?= $notification_count_obj->notification_count ?></span>
                <?php endif; ?></a></i></li>
