                ...
                <div class="user-data">
                    ...
                    <div class="coloum-01">
                        <div class="form-element">
                            ...
                            <input type="text" placeholder="Enter" id="fname" name="fname" value="<?= set_value('fname') ?>">
                        </div>
                        <div class="form-element">
                            <label for="email">Email</label>
                            <input type="text" placeholder="Enter" id="email" name="email" value="<?= set_value('email') ?>">
                        </div>
                        <div class="form-element">
                    ...
                    <div class="coloum-02">
                        <div class="form-element">
                            ...
                            <input type="text" placeholder="Enter" id="lname" name="lname" value="<?= set_value('lname') ?>">
                        </div>
                        <div class="form-element">
                            <label for="phoneNo">Phone Number</label>
                            <input type="text" placeholder="Enter" id="phoneNo" name="phoneNo" value="<?= set_value('phoneNo') ?>">
                        </div>
                        <div class="form-element">
                            <label for="cpassword">Confirm Password</label>
                            <input type="password" placeholder="Enter" id="cpassword" name="cpassword" style="border: <?= !empty($errors['cpassword']) ? '1px solid red' : '1px solid #ccc' ?>;">
