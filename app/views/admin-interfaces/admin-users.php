                    ...
                    <div class="user-data">
                        <div class="coloum-01">
                            <div class="form-element">
                                ...
                                <input value="<?= set_value('fname') ?>" name="fname" type="text" placeholder="Enter" id="fname" style="border: <?= !empty($errors['fname']) ? '1px solid red' : '1px solid #ccc' ?>;">
                            ...
                            <div class="form-element">
                                ...
                                <input value="<?= set_value('email') ?>" name="email" type="text" placeholder="Enter" id="email" style="border: <?= !empty($errors['email']) ? '1px solid red' : '1px solid #ccc' ?>;">
                            ...
                            <div class="form-element">
                                ...
                                <select name="role" id="form-element-dropdown-create">
                                    <option value="admin" class="form-element-dropdown-op" <?= (set_value('role') === 'admin') ? 'selected' : '' ?>>Admin</option>
                                    <option value="clark" <?= (set_value('role') === 'clark') ? 'selected' : '' ?>>
                                        Clark</option>
                                    <option value="director" <?= (set_value('role') === 'director') ? 'selected' : '' ?>>Director
                                    </option>
                        ...
                        <div class="coloum-02">
                            <div class="form-element">
                                ...
                                <input value="<?= set_value('lname') ?>" name="lname" type="text" placeholder="Enter" id="lname" style="border: <?= !empty($errors['lname']) ? '1px solid red' : '1px solid #ccc' ?>;">
                            ...
                            <div class="form-element">
                                ...
                                <input value="<?= set_value('phoneNo') ?>" name="phoneNo" type="text" placeholder="Enter" id="phoneNo" style="border: <?= !empty($errors['phoneNo']) ? '1px solid red' : '1px solid #ccc' ?>;">
                            ...
                            <div class="form-element">
                                ...
                                <input value="<?= set_value('username') ?>" name="username" type="text" placeholder="Enter" id="username" style="border: <?= !empty($errors['username']) ? '1px solid red' : '1px solid #ccc' ?>;">
            ...
            <div class="admin-subsection-1">
                <div class="admin-sub-title">
                    <div class="user-create-bt">
                        <button class="center" id="show-login">
                        ...
                        <ul class="responsive-table">
                            ...
                            <?php foreach ($users as $user) : ?>
                                ...
                                <li class="table-row">
                                    ...
                                    <div class="col col-6">
                                        <div onclick="onDeleteUserClick('<?= $user->id ?>')" class="user-delete" id="delete-user">
                                        ...
                                        <div onclick="onUpdateUserClick('<?= $user->id ?>', '<?= $user->fname ?>', '<?= $user->lname ?>', '<?= $user->email ?>', '<?= $user->phoneNo ?>')" class="user-update" id="show-update">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <g clip-path="url(#clip0_1448_1971)">
                                                    <path d="M14.168 2.49993C14.3868 2.28106 14.6467 2.10744 14.9326 1.98899C15.2186 1.87054 15.5251 1.80957 15.8346 1.80957C16.1442 1.80957 16.4507 1.87054 16.7366 1.98899C17.0226 2.10744 17.2824 2.28106 17.5013 2.49993C17.7202 2.7188 17.8938 2.97863 18.0122 3.2646C18.1307 3.55057 18.1917 3.85706 18.1917 4.16659C18.1917 4.47612 18.1307 4.78262 18.0122 5.06859C17.8938 5.35455 17.7202 5.61439 17.5013 5.83326L6.2513 17.0833L1.66797 18.3333L2.91797 13.7499L14.168 2.49993Z" stroke="#667085" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                                                </g>
                                                <defs>
