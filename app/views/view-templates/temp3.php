...
<body>
    <div class="temp3-home">
        <div class="temp3-title">Title</div>
        <div class="temp3-subsection-1">
            <div class="temp3-sub-title">
                Sub Title
                <div style="color:red;"> Change the Role name according to the user role.</div> </br>
                <div style="color:red;">before use this template make sure to change all class names to your own class
                    names. to reduce css inheritance.</div>
            </div>
