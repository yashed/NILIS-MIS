                ...
                <?php if ($degrees): ?>
                    <table class="Overview_table" colspan="2" style="display: flex; justify-content: center;">
                        <tr>
                            <td>
                                <b>Diploma Name</b><br>
                                <input type="text" name="name" id="name" class="name" value="<?= $degrees[0]->DegreeName ?>"
                                    readonly>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-right: 20px;">
                                ...
                                <input type="text" name="type" id="type" value="<?= $degrees[0]->DegreeShortName ?>"
                                    readonly>
                            </td>
                            <td>
                        ...
                        <div id="semester_container">
                            <?php foreach ($subjects as $semesterNumber => $semesterSubjects): ?>
                                <table class="Subject_table">
                                    <p id="Semester" name="semester" class="semester<?= $semesterNumber ?>">Semester
                                        <?= $semesterNumber ?>
                                    </p>
                                    <tr>
                                        <th>Subject Name</th>
                    ...
                    <table class="Time_table" id="Time_table">
                        ...
                        <?php if ($degreeTimeTable): ?>
                            ...
                            <?php foreach ($degreeTimeTable as $event): ?>
                                <tr>
                                    <td width="76%"><input type="text" value="<?= $event->EventName ?>" class="event"
                                            id="event_<?= $event->EventID ?>" readonly></td>
                                    ...
                                    <td width="12%"><input type="date" value="<?= $event->StartingDate ?>" class="duration"
                                            id="start_<?= $event->EventID ?>" readonly></td>
                                    <td width="12%"><input type="date" value="<?= $event->EndingDate ?>" class="duration"
                                            id="end_<?= $event->EventID ?>" readonly></td>
                                </tr>
