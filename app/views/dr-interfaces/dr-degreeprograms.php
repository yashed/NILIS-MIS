    ...
    <div class="dr-home">
        ...
        <div class="dr-subsection-1">
            ...
            <div class="button-btn">
                <button onclick="myFunction()" type="button" class="bt-name"
                    style="text-decoration: none; float: right; margin-right: 20px;">Create Degree Program</button>
            </div>
                ...
                <form id="Form3" method="post">
                            ...
                            <table class="Subject_table">
                                ...
                                <tr>
                                    ...
                                    <td width="40%"><input type="text" name="cedits_1" class="credits"
                                            placeholder="100"></td>
                                    <td width="40%"><input type="text" name="cedits_1" class="credits" placeholder="90">
                                    </td>
                                    <td width="60%"><input type="text" name="cedits_1" class="credits"
                                            placeholder="4.00"></td>
                                </tr>
                                <tr>
                                    <td width="40%"><input type="text" name="subject_1" class="subject" placeholder="A">
                                    </td>
                                    <td width="40%"><input type="text" name="cedits_1" class="credits" placeholder="89">
                                    </td>
                                    <td width="40%"><input type="text" name="cedits_1" class="credits" placeholder="80">
                                    </td>
                                    <td width="60%"><input type="text" name="cedits_1" class="credits"
                                            placeholder="4.00"></td>
                                </tr>
                                ...
                                <tr>
                                    <td width="40%"><input type="text" name="subject_1" class="subject" placeholder="B">
                                    </td>
                    ...
                    <div class="btn-box">
                        <div class="button-btn">
                            ...
                            <a type="Submit" class="bt-name" href="<?=ROOT?>dr/newDegree"
                                style="text-decoration: none; margin-right: 25px; background-color: #fff; color: #222d76;">Create</a>
                        </div>
                    </div>
                </form>
                <div class="step-row">
