        ...
        <div class="temp3-subsection-1">
            ...
            <form action="" method="POST" id="settingsForm">
                    ...
                    <div class="flex">
                        ...
                        <div id="editButtons" style="display: none;">
                            <div class="button-container">
                                ...
                                <button type="submit" name="update_user_data" class="saveBtn" id="saveBtn">Save
                                    Data</button>
                            </div>
                        </div>
                        <div id="editButton">
                ...
                <div class="user-data">
                    <div class="column-01">
                        <div class="form-element">
                            ...
                            <input type="text" placeholder="<?= $user->fname ?>" id="fname" name="fname"
                                class="form-control" value="<?= $user->fname ?>">
                    ...
                    <div class="column-02">
                        <div class="form-element">
                            ...
                            <input type="text" placeholder="<?= $user->lname ?>" id="lname" name="lname"
                ...
                <div class="form-element3">
                    ...
                    <input type="text" placeholder="<?= $user->email ?>" id="email" name="email" class="form-control"
                        value="<?= $user->email ?>">
                ...
                <div class="form-element4">
                    ...
                    <input type="text" placeholder="<?= $user->phoneNo ?>" id="phoneNo" name="phoneNo"
                        class="form-control" value="<?= $user->phoneNo ?>">
