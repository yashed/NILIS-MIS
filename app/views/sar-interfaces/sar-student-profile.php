    ...
    <div class="dr-userprofile">
            ...
            <div class="popupForm1">
                <form id="Form1" method="post" action="">
                    ...
                    <div class="input-fields" style="margin: 20px 0px 10px 0px;">
                        ...
                        <input name="degree type" id="degree_type"
                            style="width: 430px; height: 34px; border-radius: 5px; margin: 9px; padding-left: 10px"
                            placeholder="<?= $degree[0]->DegreeName ?>" disabled><br><br><br>
                        <label for="select degree type" class="drop-down">Select Degree Program:</label><br>
                        <select name="select degree type" id="select_degree_type"
                            style="width: 430px; height: 34px; border-radius: 5px; margin: 9px;">
                            <option value="" default hidden>Select</option>
                            <option value="DLMS" <?= (set_value('select_degree_type') === 'DLMS') ? 'selected' : '' ?>>
                                Diploma in Library Management Studies</option>
                            <option value="ENCM" <?= (set_value('select_degree_type') === 'ENCM') ? 'selected' : '' ?>>
                                Executive National Certificate in Management</option>
                            <option value="DSL" <?= (set_value('select_degree_type') === 'DSL') ? 'selected' : '' ?>>
                                Diploma in Science Library</option>
                        </select><br><br>
                        <h3 style="font-size: 14px; font-weight: 200">Note - After submit all the information of this
                            student may transfer to new degree program and student data will suspend from the current
                            degree program</h3>
                    </div>
                    <div class="btn-box">
                        <div class="button-btn">
                            ...
                            <button type="button" class="bt-name" style="text-decoration: none; margin-right: -53px;"
                                id="Next1" onclick="myFunction()">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="pop-up1-1">
            <div class="popupForm1-1">
                <svg onclick="crossForDiplomaChange()" id="crossForDiplomaChange" xmlns="http://www.w3.org/2000/svg"
        ...
        <div id="overlay"></div>
        <form class="pop-up2" id="deleteForm" method="post"
            action="<?= ROOT ?>dr/userprofile/delete?studentId=<?= $student[0]->id ?>">
            <div class="popupForm">
                <center><svg id="userDeletePopupImg" xmlns="http://www.w3.org/2000/svg" width="67" height="66"
                            ...
                            <div class="user-data">
                                ...
                                <div class="column-01">
                                    <div class="form-element">
                                        ...
                                        <input type="text" placeholder="Enter" id="up-name" name="name"
                                    ...
                                    <div class="form-element">
                                        ...
                                        <input type="text" placeholder="Enter" id="up-nicNo" name="nicNo"
                                            value="<?= $student[0]->nicNo ?>">
                                    </div>
                                    <div class="form-element">
                                        <label for="whatsappNo">Whatsapp Number</label>
                                        <input type="text" placeholder="Enter" id="up-whatsappNo" name="whatsappNo"
                                            value="<?= $student[0]->whatsappNo ?>">
                                    </div>
                                </div>
                                <div class="column-02">
                                    <div class="form-element">
                                        <label for="indexNo">Index Number</label>
                                        <input type="text" placeholder="Enter" id="up-country" name="country"
                                            value="<?= $student[0]->country ?>">
                                    </div>
                                    <div class="form-element">
                                        <label for="phoneNo">Phone Number</label>
                                        <input type="text" placeholder="Enter" id="up-phoneNo" name="phoneNo"
                                            value="<?= $student[0]->phoneNo ?>">
                                    </div>
                                    <div class="form-element">
                                        <label for="address">Address</label>
                                        <input type="text" placeholder="Enter" id="up-address" name="address"
                                            value="<?= $student[0]->address ?>">
                                    </div>
                                    <div class="form-element">
                                        <label for="birthdate">Birthdate</label>
                                        <input type="text" placeholder="Enter" id="up-birthdate" name="birthdate"
